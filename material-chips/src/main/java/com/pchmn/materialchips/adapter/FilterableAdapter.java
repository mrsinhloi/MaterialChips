...
public class FilterableAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public FilterableAdapter(Context context,
        ...
        mContext = context;
        width = mContext.getResources().getDimensionPixelOffset(R.dimen.chips_avatar_size_medium);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        // avatar
        if (mChipsInput.chipHasAvatarIcon() && chip.getAvatarUrl() != null) {
            itemViewHolder.mAvatar.setVisibility(View.VISIBLE);

            if (!TextUtils.isEmpty(chip.getAvatarUrl())) {
                Picasso.get()
        ...
        } else if (mChipsInput.chipHasAvatarIcon() && chip.getAvatarUri() != null) {
            itemViewHolder.mAvatar.setVisibility(View.VISIBLE);
